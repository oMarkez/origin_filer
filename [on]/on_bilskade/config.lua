...
cfg = {
	...
	cascadingFailureSpeedFactor = 12.0,			-- Sane values are 1 to 100. When vehicle health drops below a certain point, cascading failure sets in, and the health drops rapidly until the vehicle dies. Higher values means faster failure. A good starting point is 8

	degradingFailureThreshold = 120.0,			-- Below this value, slow health degradation will set in
	cascadingFailureThreshold = 110.0,			-- Below this value, health cascading failure will set in
	...
	limpModeMultiplier = 0.35,					-- The torque multiplier to use when vehicle is limping. Sane values are 0.05 to 0.25
