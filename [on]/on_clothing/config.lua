...
freemode_models = {'mp_m_freemode_01','mp_f_freemode_01','mp_m_freemode_01_p','mp_m_freemode_01_mp_m_stunt_01','mp_m_freemode_01','mp_m_freemode_01_male_freemode_business','mp_m_freemode_01_male_freemode_business2','mp_m_freemode_01_male_freemode_mplts','mp_m_freemode_01_male_heist','mp_m_freemode_01_male_hipster','mp_m_freemode_01_mp_m_bikerdlc_01','mp_m_freemode_01_mp_m_importexport_01','mp_m_freemode_01_mp_m_january2016','mp_m_freemode_01_mp_m_lowrider_01','mp_m_freemode_01_mp_m_lowrider_02','mp_m_freemode_01_mp_m_luxe_01','mp_m_freemode_01_mp_m_stunt_01','mp_m_freemode_male_apt01'}
menu_options = {
    ...
    {name = "Starter Tøj", f = listModels, param = freemode_models},
}
player_data  = {
...
local clothing_shops = {
    ...
    {name="Tøjbutik", id=73, x=270.3364868164, y=-1363.4139404296, z=24.53779220581}, -- Læge (Midtby)
    {name="Tøjbutik", id=73, x=450.73522949219, y=-992.59075927734, z=30.689588546753}, -- pd midtby
	...
	-- 424.04415893555,-800.05133056641,29.502628326416,71.358032226563
}
incircle = false
