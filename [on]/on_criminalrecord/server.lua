...
vRPclient = Tunnel.getInterface("vRP","vRP_criminalrecords")

vRPCrre = {}
Tunnel.bindInterface("vRP_criminalrecords",vRPCrre)
Proxy.addInterface("vRP_criminalrecords",vRPCrre)
vRPvRPCrreC = Tunnel.getInterface("vRP_criminalrecords","vRP_criminalrecords")
