        ...
        vRP.findFreeNumber(home_name, home.max, function(number)
          if number ~= nil then
            if vRP.tryPayment(user_id, home.buy_price) then
              ...
              TriggerClientEvent("pNotify:SendNotification", player,{text = {lang.home.buy.bought()}, type = "info", queue = "global",timeout = 4000, layout = "centerLeft",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})
            else
