														...
														vRP.request(target,"<b>"..fornavnP.." "..efternavnP.."</b> ønsker at sælge sin <b>"..name.."</b> til en pris på <b style='color: #96D3FF'>"..amount.." DKK</b>", 10, function(target,ok)
															if ok then
																...
																-- if money >= amount then
																		...
																		PerformHttpRequest('https://discordapp.com/api/webhooks/467463068364832778/UYHRthUqbiv8UrqgVDA2SSxtfhFpumtZ3hO9DhRDN_xBvbuiRvqi6XaQN5KWQWCzmnVG', function(err, text, headers) end, 'POST', json.encode({username = "Salg af køretøj - Server " .. GetConvar("servernumber","0"), content = "**"..fornavnP.." "..efternavnP.." ("..p_id..")** solgte sit køretøj **"..name.."** til **"..fornavnT.." "..efternavnT.." ("..t_id..")** for **"..amount.." DKK**."}), { ['Content-Type'] = 'application/json' })
																else
