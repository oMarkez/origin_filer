...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
  ...
  if first_spawn then -- first spawn
    ...
    -- notify last login
    SetTimeout(15000,function()TriggerClientEvent("pNotify:SendNotification", player,{text = "<h3><center><b>Velkommen til<font color= red> Origin network</font></b></h3><p><center>Tryk F9 For at bruge Menuen!</center></p>", type = "success", queue = "global", timeout = 10000, layout = "bottomCenter",animation = {open = "gta_effects_fade_in", close = "gta_effects_fade_out"}})end)
