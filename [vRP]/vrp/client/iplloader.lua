if cfg.iplload then
  Citizen.CreateThread(function()
    ...
    RequestIpl("ex_sm_13_office_01b")-- Old Spice Warm
    RequestIpl("ex_sm_13_office_01c")-- Old Spice Warm
    RequestIpl("ex_sm_13_office_03a")-- Old Spice Warm
    RequestIpl("ex_sm_13_office_03b")-- Old Spice Warm
    RequestIpl("ex_sm_13_office_03c")-- Old Spice Warm
    -- Maze Bank Building
    ...
    --RequestIpl("ex_dt1_11_office_01b")-- Old Spice Warm
    --RequestIpl("ex_dt1_11_office_01c")-- Old Spice Warm
    ...
    RequestIpl("ex_sm_15_office_01b")-- Old Spice Warm
    RequestIpl("ex_sm_15_office_01c")-- Old Spice Warm
    RequestIpl("ex_sm_15_office_03a")-- Old Spice Warm
    RequestIpl("ex_sm_15_office_03b")-- Old Spice Warm
    RequestIpl("ex_sm_15_office_03c")-- Old Spice Warm
    -- Biker
	...
	-- Nye lejligheder
	--RequestIpl("apa_v_mp_h_08_c")-- Aqua blå
	--RequestIpl("apa_v_mp_h_01_a")
	--RequestIpl("apa_v_mp_h_02_c")-- 1
	...
	-- Jasons test paradis!
	RequestIpl("hei_hw1_blimp_interior_v_comedy_milo_") -- 382.6698, -1001.339, -99.00004
	RequestIpl("hei_hw1_blimp_interior_v_motel_mp_milo_") -- 152.2605, -1004.471, -98.99999
